...
class AutoFixService:
    ...
    def _build_prompt(self, finding: Finding, playbook: FixPlaybook, context: str) -> str:
        ...
        return (
            "You are BugBunny AutoFix, a senior security engineer generating minimal"
            " safe patches.\n"
    ...
    def _system_prompt(self) -> str:
        return (
            "You are BugBunny AutoFix, a security engineer that outputs only valid JSON. "
    ...
    def _configure_git(self, repo_path: Path) -> None:
        self._run_git(repo_path, ["config", "user.name", "BugBunny"])
    ...
    def _build_pr_body(self, finding: Finding, summary: Optional[str], confidence: Optional[float], scan: Scan) -> str:
        ...
        summary_text = summary or "Automated fix generated by BugBunny."
        return (
            "## Summary\n"
            f"{summary_text}\n\n"
            "## Finding\n"
